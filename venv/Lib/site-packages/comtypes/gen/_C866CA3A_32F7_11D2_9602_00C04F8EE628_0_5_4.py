...
__all__ = [
    'SPPHRASERULE', 'ISpeechGrammarRuleState', 'SPWF_INPUT',
    'DISPID_SPIElements', 'SPFM_NUM_MODES', 'DISPID_SOTCDefault',
    'DISPID_SAVolume', 'SVP_15', 'SSFMOpenReadWrite',
    'SPINTERFERENCE_NOSIGNAL', 'SSSPTRelativeToCurrentPosition',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPVPRIORITY', 'ISpeechBaseStream', 'DISPID_SRSAudioStatus',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SFSOpen', 'SAFTDefault',
    'SVSFParseSapi', 'SECNormalConfidence', 'STCLocalServer',
    'SpeechLexiconType', 'SPDKL_DefaultLocation', 'SSTTWildcard',
    'DISPID_SOTCSetId', 'DISPID_SPIRule',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechCategoryVoices',
    'DISPID_SPRulesItem', 'DISPID_SPRuleNumberOfElements',
    'SREAdaptation', 'SpeechGrammarState', 'DISPID_SRGId',
    'SWPUnknownWordUnpronounceable', 'SRAInterpreter',
    'SpeechPropertyResourceUsage', 'DISPID_SDKSetLongValue',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRCreateRecoContext',
    'SpeechAudioFormatGUIDText', 'DISPID_SLPsItem',
    'SAFTExtendedAudioFormat', 'DISPID_SGRSTType', 'DISPID_SVSkip',
    'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE15', 'DISPID_SPRsCount',
    'DISPID_SAEventHandle', 'SAFT16kHz16BitStereo',
    'SpeechGrammarTagDictation', 'DISPID_SDKGetlongValue',
    'SPCT_SLEEP', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SOTGetAttribute', 'SPSInterjection', 'SAFT11kHz16BitMono',
    'SPBO_TIME_UNITS', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechRecoResult', 'DISPID_SPPBRestorePhraseFromMemory',
    'eLEXTYPE_PRIVATE4', 'DISPID_SGRClear',
    ...
    'SVPOver', 'SLTApp', 'SpeechRegistryUserRoot',
    'DISPID_SVEStreamStart', 'SPSMF_SAPI_PROPERTIES', 'ISpRecoResult',
    'ISpPhrase', 'DISPID_SPRuleParent', 'DISPID_SLPsCount', 'SVP_16',
    'DISPID_SRCCreateResultFromMemory', 'SpResourceManager',
    'DISPID_SPAStartElementInResult', '_RemotableHandle', 'ISpAudio',
    'DISPID_SPPEngineConfidence', 'SPRS_INACTIVE',
    'SPFM_CREATE_ALWAYS', 'DISPID_SpeechMemoryStream',
    'eLEXTYPE_PRIVATE17', 'SRARoot', 'DISPID_SVEViseme',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFT12kHz16BitMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_RESERVED9',
    'SPPS_Function', 'SPEI_MIN_TTS', 'Speech_StreamPos_RealTime',
    'DISPID_SpeechPhraseReplacement', 'ISpeechAudioFormat',
    'SECFIgnoreCase', 'ISpDataKey', 'SDKLDefaultLocation',
    'SPSHT_OTHER', 'SPRECOGNIZERSTATUS', 'DISPID_SPCLangId',
    'DISPID_SPAsItem', 'SPSEMANTICFORMAT', 'SRAExport',
    'SPCS_DISABLED', 'DISPID_SRSNumberOfActiveRules',
    'DISPIDSPTSI_ActiveOffset', 'SWTDeleted', 'DISPID_SRRPhraseInfo',
    'SpMMAudioOut', 'DISPID_SRRSaveToMemory', 'SDTReplacement',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SpeechRecognizerStatus', 'STCAll', 'SRTAutopause',
    'DISPID_SVSVisemeId', 'ISpSerializeState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPFM_CREATE',
    'SpeechAudioProperties', 'SPEI_MIN_SR', 'SVEPhoneme',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTsCount',
    'DISPID_SVSLastBookmarkId', 'Speech_Max_Pron_Length',
    'SP_VISEME_21', 'DISPIDSPTSI_ActiveLength', 'SVP_4',
    'SPAUDIOSTATUS', 'SPAS_CLOSED', 'SAFTADPCM_22kHzMono',
    'SPGS_DISABLED', 'SFTInput', 'DISPID_SRCResume',
    'SpeechDataKeyLocation', 'STCInprocHandler', 'eLEXTYPE_PRIVATE6',
    'SRSEIsSpeaking', 'DISPID_SRCEPropertyNumberChange',
    'SpeechCategoryAudioIn', 'SGRSTTEpsilon',
    ...
    'SAFTADPCM_8kHzStereo', 'SPFILEMODE', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRRTimes', 'SREFalseRecognition', 'SAFT44kHz8BitStereo',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRCEAdaptation',
    'SAFTADPCM_44kHzMono', 'SPGRAMMARSTATE', 'SPRST_INACTIVE',
    'DISPID_SGRSTPropertyValue', 'SpInprocRecognizer',
    'DISPID_SCSBaseStream', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SPEEngineConfidence', 'SAFT48kHz16BitStereo',
    'DISPID_SASFreeBufferSpace', 'SASStop', 'DISPIDSPTSI',
    'DISPID_SpeechXMLRecoResult', 'SpeechDictationTopicSpelling',
    'DISPID_SWFEChannels', 'DISPID_SPRuleConfidence',
    'DISPID_SRRSpeakAudio', 'ISpObjectTokenCategory', 'ISpShortcut',
    'SpInProcRecoContext', 'DISPID_SVEStreamEnd',
    'DISPID_SLPPartOfSpeech', 'SpeechTokenIdUserLexicon',
    'SREPrivate', 'SPPHRASEELEMENT', 'SSFMCreate',
    'SpeechAllElements', 'SPGRAMMARWORDTYPE', 'SpeechRecognitionType',
    'SAFTNonStandardFormat', 'DISPID_SPELexicalForm',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SRGState',
    'DISPID_SRRTStreamTime', 'DISPID_SVEBookmark', 'SITooLoud',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechBaseStream',
    'DISPID_SRRSetTextFeedback', 'SPSERIALIZEDPHRASE',
    'DISPID_SLWPronunciations', 'SPGS_ENABLED',
    'ISpPhoneticAlphabetConverter', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPVPRI_NORMAL', 'SP_VISEME_17', 'DISPID_SVWaitUntilDone',
    'DISPID_SPCPhoneToId', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCEBookmark', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRCCreateGrammar', 'ISpStream', 'eLEXTYPE_USER',
    'DISPID_SRRecognizer', 'DISPID_SPRText', 'eLEXTYPE_RESERVED6',
    'SP_VISEME_8', 'DISPID_SVVolume', 'SPXRO_Alternates_SML',
    'SPPS_Modifier', 'SPPARTOFSPEECH', 'ISpRecognizer',
    'DISPID_SpeechAudioBufferInfo', 'ISpeechTextSelectionInformation',
    'SpeechVoiceEvents', 'DISPID_SPPFirstElement',
    'DISPID_SGRAddResource', 'SP_VISEME_0', 'DISPID_SRCRecognizer',
    'SPBOOKMARKOPTIONS', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'IEnumString', 'SPVOICESTATUS', 'DISPID_SLWs_NewEnum',
    'DISPID_SPERequiredConfidence', 'DISPID_SRCRequestedUIType',
    'DISPID_SRCVoice', 'SP_VISEME_15', 'SAFT32kHz16BitMono',
    'SITooFast', 'SPCS_ENABLED', 'DISPID_SpeechAudioStatus',
    'SGDSActiveWithAutoPause', 'DISPID_SGRSTText', 'SPWORDLIST',
    'SVP_6', 'DISPID_SGRsCount', 'DISPID_SGRSTNextState',
    'DISPID_SpeechObjectTokenCategory', 'SDTPronunciation',
    'IInternetSecurityManager', 'SECFEmulateResult', 'SREAllEvents',
    ...
    'SpeechRecoProfileProperties', 'SPEI_END_INPUT_STREAM', 'SVP_8',
    'SpeechTokenKeyFiles', 'DISPID_SPRNumberOfElements',
    'SAFT12kHz8BitStereo', 'DISPID_SRCRetainedAudioFormat',
    'SASPause', 'DISPID_SRCESoundStart', 'SPCATEGORYTYPE',
    'DISPID_SPAsCount', 'DISPID_SOTGetStorageFileName', 'SpShortcut',
    'DISPID_SpeechPhraseElements', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRCRetainedAudio', 'ISpPhoneticAlphabetSelection',
    'DISPID_SDKEnumKeys', 'DISPID_SVRate', 'SPEI_HYPOTHESIS',
    'SPSModifier', 'ISpeechWaveFormatEx', 'DISPID_SLPPhoneIds',
    'SAFT24kHz8BitMono', 'SPEI_VOICE_CHANGE', 'ISpLexicon', 'SVP_5',
    'DISPIDSPTSI_SelectionLength', 'SPWT_LEXICAL',
    'eLEXTYPE_PRIVATE16', 'eLEXTYPE_RESERVED4',
    'Speech_Max_Word_Length', 'SAFT11kHz8BitStereo',
    'SPEI_FALSE_RECOGNITION', 'SP_VISEME_4', 'SP_VISEME_13',
    'SAFT22kHz16BitStereo', 'SPEI_START_SR_STREAM', 'SPLO_DYNAMIC',
    'ISpPhoneConverter', 'DISPID_SPIRetainedSizeBytes',
    'SAFT8kHz16BitMono', 'SASClosed', 'eWORDTYPE_ADDED', 'SGRSTTWord',
    'SPPS_RESERVED4', 'DISPID_SLGetWords', 'SPAS_PAUSE',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechPhraseElement',
    'SREInterference', 'SPRULE', 'DISPID_SVGetVoices', 'SPSFunction',
    'SPAS_STOP', 'SVP_17', 'SPVISEMES', 'SAFT12kHz8BitMono',
    'SPSTREAMFORMATTYPE', 'SpeechStreamSeekPositionType',
    'SVSFNLPSpeakPunc', 'ISpeechObjectTokenCategory',
    'DISPID_SPEAudioSizeBytes', 'SGSExclusive', 'SP_VISEME_2',
    'SPWF_SRENGINE', 'DISPID_SRCEventInterests', 'DISPID_SRDisplayUI',
    'DISPID_SRRTTickCount', 'SPINTERFERENCE_NONE',
    'DISPID_SABIEventBias', 'DISPID_SPIEngineId', 'SGDSActive',
    'SpeechCategoryAudioOut', 'DISPID_SPRules_NewEnum',
    'SPSNotOverriden', 'SP_VISEME_7', 'DISPID_SpeechGrammarRuleState',
    'SECHighConfidence', 'DISPID_SDKEnumValues', 'SVP_7',
    'ISpeechAudioBufferInfo', 'DISPID_SGRSRule', 'ISpRecognizer2',
    'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_10',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SVSyncronousSpeakTimeout',
    '_ISpeechVoiceEvents', 'SPSERIALIZEDRESULT', 'SVP_13',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SLPs_NewEnum',
    'SRERecognition', 'SPPS_NotOverriden',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SLGenerationId',
    'DISPID_SRCBookmark', 'ISpXMLRecoResult', 'SPEI_SOUND_END',
    'DISPID_SRCEFalseRecognition', 'ISpRecoCategory',
    'ISpRecoContext', 'DISPID_SVGetProfiles', 'SAFTADPCM_8kHzMono',
    'SDTProperty', 'SRTEmulated', 'SPVPRI_OVER',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPEsItem', 'ISpRecoGrammar2',
    'SPWORDTYPE', 'SAFTADPCM_11kHzMono', 'SPEVENT', 'SVSFIsXML',
    'DISPID_SRSSupportedLanguages', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPIDSPRG', 'SVESentenceBoundary', 'ISpNotifySink',
    'DISPID_SASCurrentSeekPosition', 'SPSSuppressWord', 'SPLO_STATIC',
    'tagSPPROPERTYINFO', 'DISPID_SPIGetText',
    'DISPID_SPPNumberOfElements', 'SpeechRuleState',
    'DISPID_SLWsItem', 'DISPID_SLPType',
    'DISPID_SGRSAddWordTransition', 'SPPHRASEPROPERTY',
    'DISPID_SPAs_NewEnum', 'DISPID_SBSFormat', 'SPEI_INTERFERENCE',
    'STSF_AppData', 'DISPID_SDKDeleteValue',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SGRsFindRule',
    'SREHypothesis', 'SpeechGrammarRuleStateTransitionType',
    'SpeechTokenValueCLSID', 'SAFTGSM610_44kHzMono', 'SRATopLevel',
    'eLEXTYPE_RESERVED10', 'SAFT12kHz16BitStereo',
    'SpeechVoiceCategoryTTSRate', 'SAFT24kHz8BitStereo',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRGSetWordSequenceData',
    'SpAudioFormat', 'DISPID_SOTCGetDataKey', 'DISPID_SPAPhraseInfo',
    'ISpeechLexicon', 'SpFileStream', 'DISPID_SGRSTRule',
    'SGSEnabled', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SVP_9', 'DISPID_SPRsItem', 'DISPID_SOTCId',
    'eLEXTYPE_USER_SHORTCUT', 'SP_VISEME_3', 'DISPID_SRSClsidEngine',
    'IInternetSecurityMgrSite', 'DISPID_SRCERecognition',
    'DISPID_SABIBufferSize', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVEWord', 'SVP_0', 'SPEI_SENTENCE_BOUNDARY',
    'ISpeechVoice', 'SpNullPhoneConverter',
    'DISPID_SGRSAddRuleTransition', '_SPAUDIOSTATE',
    'DISPID_SpeechVoice', 'DISPID_SOTRemoveStorageFileName',
    'SRAORetainAudio', 'SPINTERFERENCE_TOOFAST', 'SpeechFormatType',
    'DISPID_SpeechLexiconProns', 'SAFT16kHz8BitMono',
    'SpeechGrammarTagWildcard', 'SpObjectToken',
    'DISPID_SDKCreateKey', 'DISPID_SDKDeleteKey', 'UINT_PTR',
    'SpUnCompressedLexicon', 'SPEI_END_SR_STREAM', 'SSTTTextBuffer',
    'ISpeechResourceLoader', 'SPLEXICONTYPE', 'DISPID_SRIsShared',
    'SECLowConfidence', 'SpeechAudioFormatGUIDWave',
    'SPEI_PHRASE_START', 'SPBO_NONE',
    'SpeechPropertyHighConfidenceThreshold', 'SAFT24kHz16BitMono',
    'DISPID_SPRuleEngineConfidence', 'SPPS_Unknown', 'SPSNoun',
    'SPEI_PHONEME', 'SPSHORTCUTTYPE', 'SpWaveFormatEx',
    'SVEAudioLevel', 'SPEI_RESERVED1', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPCT_COMMAND', 'SPEI_SR_RETAINEDAUDIO', 'SVP_11',
    'SPTEXTSELECTIONINFO', 'DISPID_SRRGetXMLResult',
    'DISPID_SVESentenceBoundary', 'SAFTNoAssignedFormat',
    'SSSPTRelativeToEnd', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SASNonBlockingIO', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechDataKey', 'SSSPTRelativeToStart',
    'DISPID_SWFEExtraData', 'ISpeechGrammarRule', 'SP_VISEME_11',
    'DISPID_SAFSetWaveFormatEx', 'SAFTCCITT_uLaw_44kHzMono',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVSPhonemeId',
    'SGRSTTRule', 'DISPID_SRRDiscardResultInfo',
    ...
    'SVEEndInputStream', 'SpeechAudioVolume', 'SVP_10',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRGCmdSetRuleIdState',
    'SPRS_ACTIVE', 'SpeechDisplayAttributes', 'SREPropertyNumChange',
    'SAFTADPCM_11kHzStereo', 'SAFTGSM610_22kHzMono', 'ISpObjectToken',
    'DISPID_SVGetAudioOutputs', 'SpeechAddRemoveWord',
    'SGRSTTDictation', 'ISpEventSource', 'SREPhraseStart',
    'SAFT16kHz8BitStereo', 'DISPID_SVAlertBoundary', 'SP_VISEME_19',
    'DISPID_SRGIsPronounceable', 'DISPID_SRAudioInputStream',
    'SVEVoiceChange', 'DISPID_SRGDictationLoad',
    'ISpeechPhraseInfoBuilder', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSTWeight', 'SPEI_RESERVED2',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SOTDataKey', 'SVP_3',
    'DISPID_SGRSTPropertyId', 'SpeechVoiceSkipTypeSentence',
    'SPRST_INACTIVE_WITH_PURGE', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    '__MIDL_IWinTypes_0009', 'SPINTERFERENCE_NOISE', 'SPVPRI_ALERT',
    'SPWT_PRONUNCIATION', 'DISPID_SpeechGrammarRules',
    'DISPID_SPPChildren', 'SVSFIsFilename', 'SpeechUserTraining',
    'DISPID_SPRFirstElement', 'SpeechRunState',
    'SpeechCategoryRecognizers', 'SAFT44kHz16BitStereo',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SpeechCustomStream',
    'SpeechBookmarkOptions', 'DISPID_SRStatus', 'SPXMLRESULTOPTIONS',
    'SAFT22kHz8BitMono', 'SP_VISEME_5', 'DISPID_SPPsCount',
    'SECFIgnoreKanaType', 'SP_VISEME_6', 'SPLOADOPTIONS',
    'SpeechLoadOption', 'SAFT32kHz8BitStereo',
    'SAFTCCITT_ALaw_8kHzMono', 'SVSFPurgeBeforeSpeak',
    'SAFT8kHz8BitMono', 'SRADefaultToActive', 'SPSEMANTICERRORINFO',
    'DISPID_SRGetPropertyNumber', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPRuleName', 'DISPID_SGRsCommit', 'DISPID_SVSLastResult',
    'SGDSInactive', 'SVP_14', 'eLEXTYPE_VENDORLEXICON',
    'SVSFIsNotXML', 'DISPID_SpeechAudio', 'SAFT48kHz16BitMono',
    'SRSActive', 'SDA_One_Trailing_Space', 'SGDisplay',
    'SPWORDPRONOUNCEABLE', 'SpObjectTokenCategory', 'SREStreamEnd',
    'ISpeechPhraseReplacement', 'WAVEFORMATEX', 'IStream',
    'DISPID_SOTCategory', 'SRSInactiveWithPurge',
    'ISpeechGrammarRuleStateTransition', 'SPEVENTENUM',
    'SpeechAudioState', 'DISPID_SRGetPropertyString', 'SRESoundEnd',
    'SpeechPropertyComplexResponseSpeed', 'ISpeechPhraseRules',
    'DISPID_SLPSymbolic', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPPROPERTYINFO', 'SVSFlagsAsync', 'SpeechMicTraining',
    'DISPID_SGRName', 'ISequentialStream', 'SAFTCCITT_uLaw_8kHzMono',
    ...
    'DISPID_SpeechRecoResultTimes', 'SPPHRASEREPLACEMENT',
    'SSTTDictation', 'SPSHORTCUTPAIR', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechRecoContext', 'SPBO_PAUSE',
    'DISPID_SVSInputWordPosition', 'DISPID_SpeechPhraseRule',
    'ISpeechGrammarRules', 'eLEXTYPE_PRIVATE2', 'SpPhoneConverter',
    'SpeechPropertyAdaptationOn', 'SpeechCategoryAppLexicons',
    'DISPID_SPPName', 'DISPID_SVPause', 'eLEXTYPE_MORPHOLOGY',
    'eLEXTYPE_PRIVATE7', 'DISPID_SGRSAddSpecialTransition',
    'SRESoundStart', 'SVEWordBoundary', 'SINone', 'SPAUDIOOPTIONS',
    'SRERecoOtherContext', 'SITooSlow', 'SVPNormal', 'SPPS_RESERVED3',
    'eLEXTYPE_RESERVED7', 'SpStream', 'DISPID_SPEs_NewEnum',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPANumberOfElementsInResult',
    'SPSHORTCUTPAIRLIST', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPARecoResult',
    'SPAO_RETAIN_AUDIO', 'DISPID_SPEAudioTimeOffset', 'SDTAll',
    'SP_VISEME_1', 'ISpeechRecoResultDispatch', 'ISpNotifySource',
    'ISpeechCustomStream', 'SLOStatic', 'DISPID_SVEPhoneme', 'SVP_2',
    'SRCS_Enabled', 'STSF_FlagCreate', 'DISPID_SRRAudio',
    'SPWT_DISPLAY', 'DISPID_SGRSTsItem', 'SPAUDIOSTATE',
    'SFTSREngine', 'DISPID_SpeechVoiceEvent', 'ISpeechLexiconWord',
    'DISPID_SPRs_NewEnum', 'SPPHRASE', 'SVP_19',
    'DISPID_SPERetainedStreamOffset', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SDKGetStringValue', 'SPAR_High', 'SGRSTTWildcard',
    'SPAR_Low', 'SVP_12', 'DISPID_SMSAMMHandle', 'SPSHT_NotOverriden',
    'SPPS_RESERVED1', 'DISPID_SPIAudioSizeBytes', 'SAFT44kHz8BitMono',
    'SAFT48kHz8BitMono', 'DISPID_SWFEBlockAlign', 'DISPID_SPPId',
    'eLEXTYPE_RESERVED8', 'DISPID_SPACommit', 'SAFT8kHz16BitStereo',
    'SPPS_Noncontent', 'SpMemoryStream',
    'DISPID_SRCERecognitionForOtherContext', 'ISpRecognizer3',
    'SPEI_UNDEFINED', 'DISPID_SOTs_NewEnum', 'SPWORDPRONUNCIATION',
    'Speech_StreamPos_Asap', 'DISPID_SRSetPropertyString',
    'ISpeechRecoContext', 'SRCS_Disabled', 'DISPID_SRGCommit',
    'SpeechWordPronounceable', 'DISPID_SMSALineId',
    'DISPID_SPPParent', 'SpeechInterference', 'eLEXTYPE_PRIVATE11',
    'DISPID_SGRSTPropertyName', 'SpeechPartOfSpeech',
    'eLEXTYPE_PRIVATE12', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPISaveToMemory', 'SAFTADPCM_44kHzStereo',
    'ISpeechRecoResult2', 'DISPID_SRGCmdSetRuleState',
    'SpeechRuleAttributes', 'SVEViseme', 'SAFT11kHz16BitStereo',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SAFGuid',
    'DISPID_SOTDisplayUI', 'SPCT_SUB_DICTATION',
    'ISpeechRecoResultTimes', 'SDTDisplayText',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPIGrammarId',
    'SpeechRecoEvents', 'DISPID_SVSpeakStream',
    'DISPID_SVEAudioLevel', 'SDA_No_Trailing_Space', 'DISPID_SLWType',
    'eLEXTYPE_PRIVATE8', 'SRTExtendableParse', 'SVEStartInputStream',
    'SAFT16kHz16BitMono', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SLRemovePronunciation', 'DISPID_SGRsDynamic',
    'SPEI_SOUND_START', 'SpeechRecognizerState', 'DISPID_SRRTLength',
    'SPDKL_LocalMachine', 'SREStateChange', 'ISpeechDataKey',
    'SpeechSpecialTransitionType', 'DISPID_SpeechPhraseProperties',
    'SPDATAKEYLOCATION', 'SPPS_Noun', 'SPDKL_CurrentConfig',
    'DISPID_SREmulateRecognition', 'SPRST_ACTIVE',
    'DISPID_SABufferInfo', 'SLODynamic', 'SPEI_RESERVED5',
    'SpSharedRecognizer', 'ISpeechPhraseProperties',
    'DISPID_SRGReset', 'SAFT48kHz8BitStereo', 'DISPID_SGRsAdd',
    'SPSUnknown', 'SINoise', 'SpeechEngineConfidence',
    'ISpeechRecoResult', 'DISPID_SGRs_NewEnum', 'SPPS_LMA',
    'DISPID_SRRAlternates', 'DISPID_SVGetAudioInputs',
    'DISPID_SMSGetData', 'SAFT44kHz16BitMono',
    'SpeechEngineProperties', 'STSF_LocalAppData',
    'eLEXTYPE_PRIVATE10', 'DISPID_SPIReplacements',
    ...
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRCESoundEnd', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechPhraseProperty', 'SAFTCCITT_uLaw_22kHzStereo',
    'SBONone', 'SPAUDIOBUFFERINFO', 'SpeechTokenKeyAttributes',
    'DISPID_SRCEAudioLevel', 'DISPID_SpeechRecoContextEvents',
    'SGDSActiveUserDelimited', 'ISpeechPhraseElement',
    'DISPID_SRSetPropertyNumber', 'ISpeechObjectToken',
    'DISPID_SOTId', 'SpeechTokenKeyUI', 'SVSFParseAutodetect',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRCERequestUI', 'ISpEventSink',
    'SPSLMA', 'DISPID_SVPriority', 'SVEAllEvents', 'SGRSTTTextBuffer',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechVoicePriority',
    'SpMMAudioIn', 'DISPID_SRCEEnginePrivate', 'DISPID_SBSSeek',
    'DISPID_SRCEEndStream', 'ISpRecoGrammar', 'DISPID_SPRuleId',
    'DISPID_SRGDictationUnload', 'DISPID_SRRRecoContext', 'SVF_None',
    'DISPID_SVSInputWordLength', 'DISPID_SAFType', 'DISPID_SBSRead',
    'SpeechRetainedAudioOptions', 'SITooQuiet', 'DISPID_SRCPause',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechDiscardType', 'SP_VISEME_16',
    'DISPID_SOTIsUISupported', 'SpeechWordType', 'DISPID_SDKOpenKey',
    'SAFTCCITT_uLaw_11kHzStereo', 'SpeechRecoContextState',
    'SpTextSelectionInformation', 'SpPhraseInfoBuilder',
    'SPAR_Medium', 'SPEI_MAX_TTS', 'DISPID_SOTCreateInstance',
    'tagSTATSTG', 'ISpStreamFormatConverter', 'DISPID_SVEVoiceChange',
    'SRAONone', 'ISpeechXMLRecoResult', 'SpeechTokenContext',
    'SpVoice', 'DISPID_SRGSetTextSelection', 'SPBO_AHEAD',
    'SRAImport', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRGRules',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechRegistryLocalMachineRoot', 'SP_VISEME_20',
    'SSFMCreateForWrite', 'DISPID_SPCIdToPhone', 'DISPID_SPPValue',
    'SPCT_SUB_COMMAND', 'SpCompressedLexicon', 'SVEBookmark',
    'SpeechVoiceSpeakFlags', 'DISPID_SOTsItem',
    'SpeechAudioFormatType', 'eLEXTYPE_PRIVATE9',
    'SGLexicalNoSpecialChars', 'SVSFDefault', 'SAFTGSM610_11kHzMono',
    'DISPID_SGRAddState', 'SPEI_PROPERTY_STRING_CHANGE', 'SPPS_Verb',
    'ISpeechPhraseProperty', 'SVSFUnusedFlags',
    'SpeechCategoryRecoProfiles', 'DISPID_SPIProperties',
    'DISPID_SOTRemove', 'DISPID_SLWWord', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVSFParseMask', 'ISpeechRecognizer',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechPhraseReplacements', 'eLEXTYPE_APP',
    'DISPID_SPIStartTime', 'SPEI_RESERVED6', 'SREBookmark', 'SPSVerb',
    'DISPID_SpeechPhraseRules', 'SLTUser', 'ISpNotifyTranslator',
    'DISPID_SFSClose', 'SPAO_NONE', 'SpPhoneticAlphabetConverter',
    'DISPID_SAStatus', 'SpeechCategoryPhoneConverters', 'SBOPause',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPEI_TTS_BOOKMARK',
    '_ISpeechRecoContextEvents', 'DISPID_SpeechFileStream',
    'DISPID_SVAudioOutputStream', 'ISpeechAudioStatus',
    'SDKLCurrentUser', 'SPAS_RUN', 'eLEXTYPE_PRIVATE5',
    'eLEXTYPE_PRIVATE18', 'SPEI_TTS_PRIVATE', 'DISPID_SPRulesCount',
    'SDTAlternates', 'SPINTERFERENCE', 'DISPID_SPIAudioSizeTime',
    'DISPID_SVAudioOutput', 'SAFT8kHz8BitStereo', 'SPCT_DICTATION',
    'SREAudioLevel', 'SP_VISEME_12', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SWFESamplesPerSec', 'ISpeechMemoryStream',
    'DISPID_SRCEInterference', 'DISPID_SGRId',
    'DISPID_SADefaultFormat', 'SAFTText', 'DISPID_SVSpeak',
    'DISPID_SVEEnginePrivate', 'DISPID_SVSRunningState',
    'SpeechPropertyResponseSpeed', 'SPAR_Unknown', 'SVF_Stressed',
    'SRSEDone', 'SpeechStreamFileMode', 'DISPID_SVStatus',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVSCurrentStreamNumber',
    'ISpResourceManager', 'SpStreamFormatConverter', 'SVP_1',
    'SAFT22kHz16BitMono', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SpeechObjectTokens', 'SPSHT_Unknown', 'ISpGrammarBuilder',
    'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechPhraseReplacements', 'SpCustomStream', 'SINoSignal',
    'SVP_18', 'ISpRecoContext2', 'SDA_Two_Trailing_Spaces',
    'SVEPrivate', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechTokenShellFolder', 'DISPID_SVIsUISupported',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRCState',
    'SDKLCurrentConfig', 'SRSActiveAlways', 'SPEI_ADAPTATION',
    'SECFDefault', 'ISpeechRecoGrammar', 'SVPAlert', 'SDTAudio',
    'DISPID_SRGetFormat', 'DISPID_SABIMinNotification',
    'DISPID_SASCurrentDevicePosition', 'ISpProperties',
    'ISpMMSysAudio', 'LONG_PTR', 'DISPID_SBSWrite',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechLexicon', 'SpLexicon',
    'SpeechEmulationCompareFlags', 'SWPKnownWordPronounceable',
    'SAFT24kHz16BitStereo', 'DISPID_SABufferNotifySize',
    'STCInprocServer', 'SDA_Consume_Leading_Spaces',
    'ISpeechRecognizerStatus', 'SVF_Emphasis', 'SPXRO_SML',
    'SPCONTEXTSTATE', 'SpMMAudioEnum', 'SpNotifyTranslator',
    'SPSMF_UPS', 'SSFMOpenForRead', 'DISPID_SpeechObjectToken',
    'SPPS_Interjection', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRRAudioFormat', 'DISPID_SPPConfidence', 'ISpVoice',
    'DISPID_SVSInputSentencePosition', 'SPEI_VISEME',
    'SAFT32kHz8BitMono', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SGRSTsCount', 'STSF_CommonAppData', 'DISPID_SPPsItem',
    'DISPID_SWFEFormatTag', 'DISPID_SpeechGrammarRule',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVP_21', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPEDisplayText', 'DISPID_SPEsCount', 'SPEI_REQUEST_UI',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SP_VISEME_18',
    'ISpObjectWithToken', 'DISPID_SPEActualConfidence',
    'SVSFVoiceMask', 'SPEI_MAX_SR', 'DISPID_SPILanguageId',
    'DISPID_SRProfile', 'ISpeechPhraseAlternates', 'SDTRule',
    'SRADynamic', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRCSetAdaptationData', 'ISpeechAudio',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SGRSTs_NewEnum',
    'SRTSMLTimeout', 'SpeechVisemeType', 'SGLexical',
    'DISPID_SLPLangId', 'SP_VISEME_14', 'SVSFNLPMask',
    'ISpeechMMSysAudio', 'SPINTERFERENCE_TOOQUIET', 'SPRECOSTATE',
    ...
    'SPFM_OPEN_READWRITE', 'SPBINARYGRAMMAR', 'SPEI_WORD_BOUNDARY',
    'ISpeechLexiconWords', 'SPEVENTSOURCEINFO',
    'DISPID_SpeechRecoResult2', 'DISPID_SRGRecoContext',
    'SPFM_OPEN_READONLY', 'SPEI_SR_BOOKMARK', 'SVSFParseSsml',
    'DISPID_SGRInitialState', 'SRTStandard', 'SPPS_RESERVED2',
    'SAFT11kHz8BitMono', 'SRSInactive', 'DISPID_SGRSTransitions',
    'SGPronounciation', 'eLEXTYPE_PRIVATE13', 'SWTAdded',
    'DISPID_SPRuleFirstElement', 'DISPID_SPRDisplayAttributes',
    'SP_VISEME_9', 'ISpeechLexiconPronunciations', 'DISPID_SRState',
    'ISpeechFileStream', 'SECFIgnoreWidth', 'SVSFPersistXML',
    'DISPID_SRIsUISupported', 'DISPID_SLWsCount', 'SPDKL_CurrentUser',
    'DISPID_SVSInputSentenceLength', 'DISPID_SASetState', 'SASRun',
    'DISPID_SpeechPhraseInfo', 'DISPID_SMSSetData',
    'DISPID_SVDisplayUI', 'eWORDTYPE_DELETED', 'SPRECORESULTTIMES',
    'SGSDisabled', 'SpeechGrammarWordType', 'SpeechVisemeFeature',
    'DISPID_SVVoice', 'SPWORD', 'DISPID_SpeechPhraseBuilder',
    'STCRemoteServer', 'DISPID_SRRGetXMLErrorInfo',
    'SECFNoSpecialChars', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRCEPhraseStart', 'DISPID_SLWLangId', 'SRERequestUI',
    'DISPID_SGRAttributes', 'DISPID_SVResume', 'ISpPhraseAlt',
    'SPPS_SuppressWord', 'DISPID_SASState', 'SVP_20',
    'DISPID_SOTSetId', 'ISpeechVoiceStatus', 'SPEI_SR_PRIVATE',
    'DISPID_SLGetGenerationChange', 'SPSHT_EMAIL', 'SREStreamStart',
    'ISpStreamFormat', 'SpSharedRecoContext'
]

_check_version('1.2.0', 1668287535.090009)
